    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start mb-24 gap-12">
            <div class="max-w-xl">
                <div class="mb-8">
                    <!-- Logo mark -->
                    <svg width="40" height="51" viewBox="0 0 90 115" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div>
                <a href="#contact" class="rounded-full bg-black px-6 py-3 text-sm font-medium text-white hover:bg-gray-800 transition-colors inline-block">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8 mb-24 border-t border-gray-100 pt-16">
            <div>
                ...
                <ul class="space-y-4">
                    <li><a href="#grc" class="text-xs text-gray-600 hover:text-gray-900">GRC Modernization</a></li>
                    <li><a href="#compliance" class="text-xs text-gray-600 hover:text-gray-900">Compliance Automation</a></li>
                    <li><a href="#ai" class="text-xs text-gray-600 hover:text-gray-900">AI Implementation</a></li>
                </ul>
            </div>
            <div>
                ...
                <ul class="space-y-4">
                    ...
                    <li><a href="#team" class="text-xs text-gray-600 hover:text-gray-900">Our Team</a></li>
            ...
            <div>
                ...
                <ul class="space-y-4">
                    ...
                    <li><a href="#consultation" class="text-xs text-gray-600 hover:text-gray-900">Schedule Consultation</a></li>
